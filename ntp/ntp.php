...
<head>
    ...
    <title>NTP Auto-Entry Panel</title>
            ...
            <div class="col-md-7 col-lg-6">
                ...
                <div class="card main-card">
                    <div class="card-header-custom">
                        ...
                        <h3 class="mb-0">Robot Entri NTP</h3>
                    ...
                    <div class="card-body-custom">
                        ...
                        <form action="prosesntp.php" method="POST" enctype="multipart/form-data">
                        ...
                        <form id="runOnlyForm" action="prosesntp.php" method="POST" style="display:none;">
